...
class SharedStream extends EventEmitter {
     ...
     * @param {VoiceConnection} connection The voice connection to add
     */
    add(connection) {
     ...
     * @param {Number} [options.frameDuration=60] The resource opus frame duration (required for DCA/Ogg)
     ...
     * @param {Number} [options.sampleRate=48000] The resource audio sampling rate
     ...
     * @param {VoiceConnection} connection The voice connection to remove
     */
    remove(connection) {
