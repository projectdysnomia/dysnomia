...
class GuildChannel extends Channel {
    ...
    */
    deletePermission(overwriteID, reason) {
        return this.client.rest.deleteChannelPermission(this.id, overwriteID, reason);
    }
    ...
    */
    edit(options, reason) {
        return this.client.rest.editChannel(this.id, options, reason);
    }
    ...
    */
    editPermission(overwriteID, allow, deny, type, reason) {
        return this.client.rest.editChannelPermission(this.id, overwriteID, allow, deny, type, reason);
    }
    ...
    */
    editPosition(position, options) {
        return this.client.rest.editChannelPosition(this.id, position, options);
    }
