...
class GuildChannel extends Channel {
     ...
     * @param {Number?} [options.parentID] The ID of the parent channel category for this channel (guild text/voice channels only) or the channel ID where the thread originated from (thread channels only)
     ...
     * @param {String} overwriteID The ID of the overwritten user or role
     * @param {BigInt | Number} allow The permissions number for allowed permissions
     * @param {BigInt | Number} deny The permissions number for denied permissions
     ...
     * @param {Boolean} [options.lockPermissions] Whether to sync the permissions with the new parent if moving to a new category
