...
const InteractionMetadata = require("./InteractionMetadata");
...
class Message extends Base {
     ...
     * @param {Boolean} [options.attachments[].is_spoiler] Whether the attachment is a spoiler or not
     * @param {Number} [options.attachments[].duration_secs] The duration of the attachment in seconds (required for voice messages)
     * @param {String} [options.attachments[].waveform] The base64 encoded waveform of the attachment (required for voice messages)
