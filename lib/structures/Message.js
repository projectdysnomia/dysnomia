...
* @prop {Command?} command [DEPRECATED] The Command used in the Message, if any (CommandClient only)
...
* @prop {String?} prefix [DEPRECATED] The prefix used in the Message, if any (CommandClient only)
...
class Message extends Base {
    ...
    */
    getReaction(reaction, options) {
        ...
        return this._client.getMessageReaction.call(this._client, this.channel.id, this.id, reaction, options);
    }
