...
class GuildTemplate {
    ...
    */
    createGuild(name, icon) {
        return this.#client.rest.createGuildFromTemplate(this.code, name, icon);
    }
    ...
    */
    delete() {
        return this.#client.rest.deleteGuildTemplate(this.sourceGuild.id, this.code);
    }
    ...
    */
    edit(options) {
        return this.#client.rest.editGuildTemplate(this.sourceGuild.id, this.code, options);
    }
    ...
    */
    sync() {
        return this.#client.rest.syncGuildTemplate(this.sourceGuild.id, this.code);
    }
