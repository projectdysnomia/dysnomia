...
class User extends Base {
    ...
    update(data) {
        ...
        if(data.avatar_decoration_data !== undefined) {
            /**
             * The data of the user's avatar decoration, or null if no avatar decoration
             * @type {Object?}
             */
        ...
        if(data.collectibles !== undefined) {
            /**
             * The user's collectibles, or null if the user hasn't got any
             * @type {User.Collectibles?}
             */
    ...
    /**
     * The URL of the user's avatar decoration, which is usually an animated PNG
     * @type {String?}
     */
    get avatarDecorationURL() {
        ...
        const url = Endpoints.USER_AVATAR_DECORATION_PRESET(this.avatarDecorationData.asset);
        return `${Endpoints.CDN_URL}${url}.png`;
    }
 ...
 * @typedef User.Collectibles
 * @prop {User.Nameplate} [nameplate] The nameplate the user has
 */
/**
 * The nameplate data
 * @typedef User.Nameplate
 * @prop {String} sku_id The ID of the nameplate SKU
 * @prop {String} asset Path to the nameplate asset
 * @prop {String} label The label of the nameplate
 * @prop {String} palette The background color of the nameplate
 */
/**
 * User's primary guild data
 * @typedef User.PrimaryGuild
 * @prop {String?} badge The hash of the guild badge
 * @prop {Boolean?} identityEnabled Whether the primary guild's server tag is displayed or not
 * @prop {String?} identityGuildID The ID of the primary guild
 * @prop {String?} tag The guild tag
 */
