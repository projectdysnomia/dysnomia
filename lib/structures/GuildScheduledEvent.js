...
class GuildScheduledEvent extends Base {
     ...
     */
    delete() {
        return this.#client.deleteGuildScheduledEvent.call(this.#client, this.guild.id, this.id);
    }
     ...
     */
    edit(event, reason) {
        return this.#client.editGuildScheduledEvent.call(this.#client, this.guild.id, this.id, event, reason);
    }
