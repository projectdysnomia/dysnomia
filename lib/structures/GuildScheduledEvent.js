...
class GuildScheduledEvent extends Base {
    ...
    */
    delete() {
        return this.#client.rest.deleteGuildScheduledEvent(this.guildID, this.id);
    }
    ...
    */
    edit(event, reason) {
        return this.#client.rest.editGuildScheduledEvent(this.guildID, this.id, event, reason);
    }
    ...
    */
    getUsers(options) {
        return this.#client.rest.getGuildScheduledEventUsers(this.guild.id, this.id, options);
    }
