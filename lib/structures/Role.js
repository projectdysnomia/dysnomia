...
class Role extends Base {
     ...
     * @param {BigInt | Number} [options.permissions] The role permissions number
 ...
 * @typedef {Object} Role.RoleColors
 * @prop {Number} primaryColor The primary color of the role
 * @prop {Number?} [secondaryColor] The secondary color of the role (makes the role gradient)
 * @prop {Number?} [tertiaryColor] The tertiary color of the role (makes the role holographic)
 */
