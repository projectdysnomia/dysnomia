...
class Role extends Base {
    ...
    */
    delete(reason) {
        return this.guild.shard.client.rest.deleteRole(this.guild.id, this.id, reason);
    }
    ...
    */
    edit(options, reason) {
        return this.guild.shard.client.rest.editRole(this.guild.id, this.id, options, reason);
    }
    ...
    */
    editPosition(position) {
        return this.guild.shard.client.rest.editRolePosition(this.guild.id, this.id, position);
    }
