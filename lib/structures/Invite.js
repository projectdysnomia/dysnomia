...
class Invite extends Base {
     ...
     * @param {Array<String>} users An array of user IDs allowed to use this invite
     * @returns {Promise}
     */
    editTargetUsers(users) {
        return this.#client.editInviteTargetUsers.call(this.#client, this.code, users);
    }
