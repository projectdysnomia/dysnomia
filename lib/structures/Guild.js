...
class Guild extends Base {
    ...
    /**
    * [DEPRECATED] Add a discovery subcategory
    ...
    */
    banMember(userID, options) {
        return this._client.banGuildMember.call(this._client, this.id, userID, options);
    }
    ...
    bulkBanMembers(userIDs, options) {
        return this._client.bulkBanGuildMembers.call(this._client, this.id, userIDs, options);
    }
    ...
    */
    createChannel(name, type, options) {
        return this._client.createChannel.call(this._client, this.id, name, type, options);
    }
    ...
    */
    ...
    /**
    * [DEPRECATED] Delete a discovery subcategory
    * @arg {String} categoryID The ID of the discovery category
    * @arg {String} [reason] The reason to be displayed in audit logs
    * @returns {Promise}
    */
    ...
    */
    ...
    /**
    * [DEPRECATED] Edit the guild's discovery data
    ...
    */
    ...
    editMFALevel(options) {
        return this._client.editGuildMFALevel.call(this._client, this.id, options);
    }
    ...
    editOnboarding(options) {
        return this._client.editGuildOnboarding.call(this._client, this.id, options);
    }
    ...
    */
    ...
    /**
    * [DEPRECATED] Request all guild members from Discord
    ...
    */
    fetchAllMembers(timeout) {
        emitDeprecation("FETCH_ALL_MEMBERS");
        this._client.emit("warn", "[DEPRECATED] Guild#fetchAllMembers is deprecated. Use Guild#fetchMembers instead");
    ...
    */
    ...
    /**
     * [DEPRECATED] Get the guild's discovery object
     * @returns {Promise<Object>}
     */
    getDiscovery() {
    ...
    */
    getRESTMembers(options) {
        return this._client.getRESTGuildMembers.call(this._client, this.id, options);
    }
