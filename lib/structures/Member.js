...
class Member extends Base {
    ...
    */
    addRole(roleID, reason) {
        return this.guild.shard.client.rest.addGuildMemberRole(this.guild.id, this.id, roleID, reason);
    }
    ...
    */
    ban(options) {
        return this.guild.shard.client.rest.banGuildMember(this.guild.id, this.id, options);
    }
    ...
    */
    edit(options, reason) {
        return this.guild.shard.client.rest.editGuildMember(this.guild.id, this.id, options, reason);
    }
    ...
    */
    kick(reason) {
        return this.guild.shard.client.rest.kickGuildMember(this.guild.id, this.id, reason);
    }
    ...
    */
    removeRole(roleID, reason) {
        return this.guild.shard.client.rest.removeGuildMemberRole(this.guild.id, this.id, roleID, reason);
    }
    ...
    */
    unban(reason) {
        return this.guild.shard.client.rest.unbanGuildMember(this.guild.id, this.id, reason);
    }
