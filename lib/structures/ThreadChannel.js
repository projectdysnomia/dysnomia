...
class ThreadChannel extends GuildChannel {
    ...
    */
    ...
    getMember(memberID, options) {
        return this.client.rest.getThreadMember(this.id, memberID, options);
    }
    ...
    */
    getMembers(options) {
        return this.client.rest.getThreadMembers(this.id, options);
    }
    ...
    */
    join(userID) {
        return this.client.rest.joinThread(this.id, userID);
    }
    ...
    */
    leave(userID) {
        return this.client.rest.leaveThread(this.id, userID);
    }
    ...
    */
    purge(options) {
        return this.client.rest.purgeChannel(this.id, options);
    }
