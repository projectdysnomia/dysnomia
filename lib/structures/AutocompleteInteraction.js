...
class AutocompleteInteraction extends Interaction {
     ...
     * @param {Array<Object>} choices The autocomplete choices to return to the user
     * @param {String | Number} choices[].name The choice display name
     * @param {String} choices[].value The choice value to return to the bot
     * @returns {Promise}
     */
    acknowledge(choices) {
