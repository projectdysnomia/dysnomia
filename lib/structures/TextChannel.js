...
class TextChannel extends GuildChannel {
    ...
    */
    createThread(options) {
        return this.client.rest.createThread(this.id, options);
    }
    ...
    */
    createThreadWithMessage(messageID, options) {
        return this.client.rest.createThreadWithMessage(this.id, messageID, options);
    }
    ...
    */
    createWebhook(options, reason) {
        return this.client.rest.createChannelWebhook(this.id, options, reason);
    }
    ...
    */
    getArchivedThreads(type, options) {
        return this.client.rest.getArchivedThreads(this.id, type, options);
    }
    ...
    */
    getJoinedPrivateArchivedThreads(options) {
        return this.client.rest.getJoinedPrivateArchivedThreads(this.id, options);
    }
    ...
    */
    getPins() {
        return this.client.rest.getPins(this.id);
    }
    ...
    */
    getWebhooks() {
        return this.client.rest.getChannelWebhooks(this.id);
    }
    ...
    */
    pinMessage(messageID) {
        return this.client.rest.pinMessage(this.id, messageID);
    }
    ...
    */
    unpinMessage(messageID) {
        return this.client.rest.unpinMessage(this.id, messageID);
    }
