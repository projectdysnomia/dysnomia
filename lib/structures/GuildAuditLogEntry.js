...
class GuildAuditLogEntry extends Base {
    ...
    get target() { // pay more, get less
        if(this.actionType < 10) { // Guild
            return this.guild;
        } else if(this.actionType < 20 || this.actionType === AuditLogActions.VOICE_CHANNEL_STATUS_UPDATE || this.actionType === AuditLogActions.VOICE_CHANNEL_STATUS_DELETE) { // Channel
