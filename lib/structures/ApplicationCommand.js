...
class ApplicationCommand extends Base {
    ...
    constructor(data, client) {
        ...
        if(data.handler !== undefined) {
            /**
             * The [handler type](https://discord.com/developers/docs/interactions/application-commands#application-command-object-entry-point-command-handler-types) for primary entry point commands
             * @type {Number?}
             */
