...
class ApplicationCommand extends Base {
     ...
     */
    delete() {
        return this.guildID === undefined ? this.#client.rest.deleteCommand(this.id) : this.#client.rest.deleteGuildCommand(this.guildID, this.id);
    }
    ...
    */
    edit(options) {
        return this.guildID === undefined ? this.#client.rest.editCommand(this.id, options) : this.#client.rest.editGuildCommand(this.id, this.guildID, options);
    }
