...
class ForumChannel extends GuildChannel {
     ...
     * @param {Array<String>} [options.appliedTags] The tags to apply to the thread
     ...
     * @param {String} type The type of thread channel - for forum channels, only "public" is available
