...
module.exports.ChannelTypes = {
    ...
    ANNOUNCEMENT_THREAD:  10, GUILD_NEWS_THREAD: 10, // [DEPRECATED]
    PUBLIC_THREAD:        11, GUILD_PUBLIC_THREAD: 11, // [DEPRECATED]
...
const Intents = {
    guilds:                      1 << 0,
    guildMembers:                1 << 1,
    guildModeration:             1 << 2, guildBans: 1 << 2, // [DEPRECATED]
...
module.exports.MessageTypes = {
    ...
    USER_JOIN:                                    7, GUILD_MEMBER_JOIN: 7, // [DEPRECATED]
    GUILD_BOOST:                                  8, USER_PREMIUM_GUILD_SUBSCRIPTION: 8, // [DEPRECATED]
    GUILD_BOOST_TIER_1:                           9, USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_1: 9, // [DEPRECATED]
    GUILD_BOOST_TIER_2:                           10, USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_2: 10, // [DEPRECATED]
    GUILD_BOOST_TIER_3:                           11, USER_PREMIUM_GUILD_SUBSCRIPTION_TIER_3: 11, // [DEPRECATED]
...
const Permissions = {
    ...
    manageGuildExpressions:           1n << 30n, manageEmojisAndStickers: 1n << 30n,
...
module.exports.UserFlags = {
    NONE:                         0,
    STAFF:                        1 << 0,  DISCORD_STAFF: 1 << 0, DISCORD_EMPLOYEE: 1 << 0, // [DEPRECATED]
    PARTNER:                      1 << 1,  PARTNERED_SERVER_OWNER: 1 << 1, DISCORD_PARTNER: 1 << 1, // [DEPRECATED]
    HYPESQUAD:                    1 << 2,  HYPESQUAD_EVENTS: 1 << 2, // [DEPRECATED]
    BUG_HUNTER_LEVEL_1:           1 << 3,
    HHYPESQUAD_ONLINE_HOUSE_1:    1 << 6,  HOUSE_BRAVERY : 1 << 6, // [DEPRECATED]
    HYPESQUAD_ONLINE_HOUSE_2:     1 << 7,  HOUSE_BRILLIANCE: 1 << 7, // [DEPRECATED]
    HYPESQUAD_ONLINE_HOUSE_3:     1 << 8,  HOUSE_BALANCE: 1 << 8, // [DEPRECATED]
