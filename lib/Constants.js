...
module.exports.GuildScheduledRecurrenceRuleFrequency = {
    YEARLY:  0,
    MONTHLY: 1,
    WEEKLY:  2,
    DAILY:   3
...
module.exports.GuildScheduledRecurrenceRuleWeekday = {
    MONDAY:    0,
    TUESDAY:   1,
    WEDNESDAY: 2,
    THURSDAY:  3,
...
module.exports.GuildScheduledRecurrenceRuleMonth = {
    JANUARY:   1,
    FEBRUARY:  2,
    MARCH:     3,
    APRIL:     4,
