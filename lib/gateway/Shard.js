        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "PRESENCE_UPDATE": {
                if(packet.d.user.username !== undefined) {
                    ...
                    let oldUser = null;
                    if(user && (user.username !== packet.d.user.username || user.discriminator !== packet.d.user.discriminator || user.avatar !== packet.d.user.avatar || user.globalName !== packet.d.user.global_name || user.avatarDecoration !== packet.d.user.avatar_decoration)) {
                        oldUser = {
                    ...
                    if(!user || oldUser) {
                        ...
                        * @prop {String?} oldUser.avatar_decoration The hash of the user's avatar decoration, or null if no avatar decoration
                        */
