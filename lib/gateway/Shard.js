    ...
    wsEvent(packet) {
        switch(packet.t) { // (╯°□°）╯︵ ┻━┻
            ...
            case "VOICE_CHANNEL_EFFECT_SEND": {
                 ...
                 * @prop {AnyVoiceChannel | Object} effect.channel The voice channel the effect was sent in. If the channel is not cached, this will be an object with an `id` key. No other property is guaranteed
