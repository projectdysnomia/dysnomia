            ...
            case "PRESENCE_UPDATE": {
                if(packet.d.user.username !== undefined) {
                    ...
                    if(user && (user.username !== packet.d.user.username
                        ...
                        // TODO(TTtie): checking some of these properties is redundant as they drop the badge entirely. Determine which
                        || user.primaryGuild?.identity_enabled !== packet.d.user.primary_guild?.identity_enabled
