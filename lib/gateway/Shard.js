                ...
                this.emit("autoModerationRuleCreate", guild, {
                    ...
                    triggerMetadata: packet.d.trigger_metadata ? {
                        get allowList() {
                            ...
                            return packet.d.trigger_metadata.allow_list;
                        },

                        get keywordFilter() {
                            emitDeprecation("AUTOMOD_CAMEL_CASE_TRIGGER_META");
                            return packet.d.trigger_metadata.keyword_filter;
                        },

                        get mentionTotalLimit() {
                            emitDeprecation("AUTOMOD_CAMEL_CASE_TRIGGER_META");
                            return packet.d.trigger_metadata.mention_total_limit;
                        },

                        get regexPatterns() {
                            emitDeprecation("AUTOMOD_CAMEL_CASE_TRIGGER_META");
                            return packet.d.trigger_metadata.regex_patterns;
                        },

                        ...packet.d.trigger_metadata
                    } : undefined,
