    ...
    wsEvent(packet) {
        switch(packet.t) { // (╯°□°）╯︵ ┻━┻
            ...
            case "VOICE_CHANNEL_EFFECT_SEND": {
                ...
                /**
                 * Fired when a user send a voice channel effect
                 * @event Client#voiceChannelEffectSend
                 * @prop {Object} effect The effect that was sent
                 * @prop {Guild | Object} effect.guild The guild. If the guild is not cached, this will be an object with an `id` key. No other property is guaranteed
                 * @prop {VoiceChannel | Object} effect.channel The voice channel the effect was sent in. If the channel is not cached, this will be an object with an `id` key. No other property is guaranteed
                 * @prop {User | Object} effect.user The user. If the user is not cached, this will be an object with an `id` key. No other property is guaranteed
                 ...
                 * @prop {number?} effect.soundVolume The volume of the sound, would be a number between 1 and 0
                 */
