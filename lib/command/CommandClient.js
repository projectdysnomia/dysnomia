...
/**
* [DEPRECATED] Represents a Dysnomia client with the command framework
* @extends Client
...
class CommandClient extends Client {
    ...
    * @arg {Object} options Dysnomia options (same as Client)
    ...
    * @arg {String} [commandOptions.description="A Dysnomia-based Discord bot"] The description to show in the default help command
    ...
    */
    constructor(token, options, commandOptions) {
        ...
        this.commandOptions = Object.assign({
            ...
            description: "A Dysnomia-based Discord bot",
            ignoreBots: true,
            ignoreSelf: true,
            name: null,
