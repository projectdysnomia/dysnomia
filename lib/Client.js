...
class Client extends EventEmitter {
    ...
    * @arg {Boolean} [options.autoreconnect=true]  [DEPRECATED] Have Dysnomia autoreconnect when connection is lost. This option has been moved under `options.gateway`
    ...
    * @arg {Object} [options.disableEvents]  [DEPRECATED] If disableEvents[eventName] is true, the WS event will not be processed. This can cause significant performance increase on large bots. [A full list of the WS event names can be found in Discord's documentation](https://discord.com/developers/docs/topics/gateway-events#receive-events). This option has been moved under `options.gateway`
    ...
    * @arg {Number | Array<String | Number>} [options.intents] [DEPRECATED] A list of [intent names](https://github.com/projectdysnomia/dysnomia/blob/dev/lib/Constants.js#L311), pre-shifted intent numbers to add, or a raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled. This option has been moved under `options.gateway`
    ...
    * @arg {Number} [options.latencyThreshold=30000] [DEPRECATED] The average request latency at which Dysnomia will start emitting latency errors. This option has been moved under `options.rest`
