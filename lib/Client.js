...
class Client extends EventEmitter {
    ...
    */
    ...
    /**
    * [DEPRECATED] Add a guild discovery subcategory
    ...
    */
    addGuildDiscoverySubcategory(guildID, categoryID, reason) {
        emitDeprecation("DISCOVERY_UNDOCUMENTED");
    ...
    */
    ...
    /**
    * [DEPRECATED] Create a thread without an existing message
    * @arg {String} channelID The ID of the channel
    * @arg {Object} options The thread options
    * @arg {Number} [options.autoArchiveDuration] Duration in minutes to automatically archive the thread after recent activity, either 60, 1440, 4320 or 10080
    * @arg {Boolean} [options.invitable] Whether non-moderators can add other non-moderators to the thread (private threads only)
    ...
    */
    createThreadWithoutMessage(channelID, options) {
        ...
        this.emit("warn", "[DEPRECATED] Using createThreadWithoutMessage() to create a thread will be removed in future versions. Use createThread() instead.");
    ...
    */
    ...
    /**
    * [DEPRECATED] Delete a guild discovery subcategory
    * @arg {String} guildID The ID of the guild
    * @arg {String} categoryID The ID of the discovery category
    * @arg {String} [reason] The reason to be displayed in audit logs
    * @returns {Promise}
    ...
    */
    ...
    /**
    * [DEPRECATED] Edit a guild's discovery data
    * @arg {String} guildID The ID of the guild
    ...
    */
    ...
    /**
    * [DEPRECATED] Get a list of discovery categories
    ...
    * @returns {Promise<{autoModerationRules: Array<Object>, commands: Array<ApplicationCommand>, entries: Array<GuildAuditLogEntry>, events: Array<GuildScheduledEvent>, integrations: Array<PartialIntegration>, threads: Array<NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel>, users: Array<User>, webhooks: Array<Webhook>}>}
    */
    ...
    */
    ...
    /**
    * [DEPRECATED] Get a guild's discovery object
    * @arg {String} guildID The ID of the guild
    * @returns {Promise<Object>}
    */
    ...
    * @arg {String} inviteID The ID of the invite
    * @arg {Object | Boolean} [options] Options for fetching the invite. [DEPRECATED] If a boolean is passed, it behaves as setting `options.withCounts`.
    ...
    * @arg {Boolean} [withExpiration] [DEPRECATED] Whether to fetch the expiration time or not
    * @returns {Promise<Invite>}
    */
    getInvite(inviteID, options = {}, withExpiration) {
        if(typeof options === "boolean") { // Deprecated legacy path
            emitDeprecation("GET_INVITE_PARAMETRIC_OPTIONS");
            options = {
                withCounts: options,
    ...
    */
    ...
    /**
    * [DEPRECATED] Validate discovery search term
