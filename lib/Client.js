...
class Client extends EventEmitter {
    ...
    */
     ...
     * @param {String} channelID The channel to create the thread in
    ...
    createForumThread(channelID, options) {
        ...
        if(options.message !== undefined) {
            ...
            if(options.message.file !== undefined) {
                maybeFile = options.message.file;
                delete options.message.file;
            }
        }

        // Maybe merge with createThreadWithoutMessage?
        ...
        }, maybeFile).then((channel) => Channel.from(channel, this));
    }
