...
class Client extends EventEmitter {
     ...
     * @param {Boolean} [options.opusOnly=false] Whether to suppress the Opus encoder not found error or not [DEPRECATED]
    ...
    constructor(token, options) {
        super();
        if(options && typeof options.opusOnly !== "undefined") {
            emitDeprecation("NEW_VOICE_CONFIG");
        }
        ...
        this.options.voice.opusOnly ??= this.options.opusOnly;
