...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.gateway.gateway_url] A custom gateway url to allow the use of gateway proxies
    ...
    */
    async connect() {
        ...
        try {
            let data;
            if(this.options.gateway.gateway_url) {
                data = {url: this.options.gateway.gateway_url};
            } else {
