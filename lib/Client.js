...
class Client extends EventEmitter {
     ...
     * @param {String} inviteID The ID of the invite
     * @returns {Promise<String>} A CSV file with a single column of user IDs allowed to accept the invite (TBD)
     */
    getInviteTargetUsers(inviteID) {
        return this.requestHandler.request("GET", Endpoints.INVITE_TARGET_USERS(inviteID), true);
    }
