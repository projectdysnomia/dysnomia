...
class Client extends EventEmitter {
    ...
    * @arg {String} messageID The ID of the message
    * @arg {String} [threadID] The ID of the thread channel if the message is in a thread
    * @returns {Promise}
    */
    ...
    */
     ...
     * @returns {Promise<Object[]>} An array of application emojis with creator data
     */
    ...
    * @arg {Number} [options.type=0] The type of reaction to get
