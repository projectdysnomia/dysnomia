...
class Client extends EventEmitter {
    ...
    searchGuildMessages(guildID, options) {
        return this.requestHandler.request("GET", Endpoints.GUILD_MESSAGES_SEARCH(guildID), true, {
        ...
        }).then((data) => data.code !== undefined
            // TODO: should we catch this and wait or do we leave it up to the user?
            ? {
            ...
            : {
                    ...
                    messages: data.messages.map((array) => array.map((message) => new Message(message, this))),
