...
class SequentialBucket {
     ...
     * @param {Number} limit The max number of tokens the bucket can consume per interval
     * @param {Object} [latencyRef] An object
     * @param {Number} latencyRef.latency Interval between consuming tokens
     */
     ...
     * @param {Function} func A function to call when a token can be consumed. The function will be passed a callback argument, which must be called to allow the bucket to continue to work
     */
    queue(func, short) {
        if(short) {
