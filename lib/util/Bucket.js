...
class Bucket {
     ...
     * @param {Number} interval How long (in ms) to wait between clearing used tokens
     * @param {Object} [options] Optional parameters
     * @param {Object} options.latencyRef A latency reference object
     * @param {Number} options.latencyRef.latency Interval between consuming tokens
     * @param {Number} options.reservedTokens How many tokens to reserve for priority operations
     */
