...
/* eslint-disable @stylistic/no-multi-spaces -- currently-aligned manually */
...
module.exports.INVITE_TARGET_USERS =                                  (inviteID) => `/invites/${inviteID}/target-users`;
module.exports.INVITE_TARGET_USER =                           (inviteID, userID) => `/invites/${inviteID}/target-users/${userID}`;
module.exports.INVITE_TARGET_USERS_BULK_ADD =                         (inviteID) => `/invites/${inviteID}/target-users/bulk-add`;
module.exports.INVITE_TARGET_USERS_BULK_DELETE =                      (inviteID) => `/invites/${inviteID}/target-users/bulk-delete`;
module.exports.INVITE_TARGET_USERS_JOB_STATUS =                       (inviteID) => `/invites/${inviteID}/target-users/job-status`;
...
module.exports.GUILD_TAG_BADGE =                            (guildID, badgeHash) => `/guild-tag-badges/${guildID}/${badgeHash}`;
...
module.exports.USER_AVATAR_DECORATION_PRESET =                  (userDecoration) => `/avatar-decoration-presets/${userDecoration}`;
